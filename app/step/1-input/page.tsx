    ...
    <div className="space-y-6 p-6 max-w-[1600px] mx-auto animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-zinc-900/50 p-6 rounded-xl border border-zinc-800">
        ...
        <button 
          ...
          className="bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-3 rounded-lg font-bold shadow-lg shadow-indigo-500/20 flex items-center gap-2 transition-all active:scale-95 whitespace-nowrap cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-6 hover:border-zinc-700 transition-colors">
          ...
          <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl h-48 flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
            ...
            <p className="text-zinc-500 text-sm mb-4 max-w-xs">Conecte a API do YouTube para obter dados em tempo real.</p>
            <button 
              onClick={() => setShowModal(true)}
              className="text-xs bg-zinc-800 hover:bg-zinc-700 text-white px-4 py-2 rounded-md transition-colors border border-zinc-700 cursor-pointer"
            >
              Configurar Agora
            </button>
          </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full bg-zinc-900 border border-zinc-800 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
            />
          </div>
        </div>
      </div>
