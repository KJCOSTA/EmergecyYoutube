      ...
      <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input type="text" placeholder="Ex: Oração da Manhã Espírita..." className="w-full bg-zinc-900 border border-zinc-800 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all" />
          </div>
        </div>
      </div>
