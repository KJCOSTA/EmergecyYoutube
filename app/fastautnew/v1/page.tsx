...
export default function FastAutnewV1() {
  ...
  const [data, setData] = useState<StepData>(null)

  return (
    <div style={{ padding: 32 }}>
      {step === 1 && <Step1 onNext={(d: StepData) => { setData(d); setStep(2) }} />}
      {step === 2 && <Step2 data={data} onNext={(d: StepData) => { setData(d); setStep(3) }} />}
